<%-- 
    Document   : Feedback
    Created on : Oct 7, 2023, 12:40:44 PM
    Author     : ASUS
--%>
        ...
        <nav class="navbar navbar-expand bg navbar-light sticky-top px-2px-lg-3 py-lg-0" style="background-color: #FCECB2 ">
            ...
            <div  style="margin-left:50px;"class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                  ...
                  <a href="viewFeedback.html" class="nav-item nav-link active">Feedback</a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 feedback-user">
                    ...
                    <button><a href="viewFeedback.html">VIEW FEEDBACK</a></button>
                </div>
                <div class="col-md-7 feedback-content">
                    <form action="SendFeedbackServlet" method="post">
                        ...
                        <div class="m-3">
                            <input type="text" name="title" class="form-control mx-1" placeholder="Title...">
                        </div>
                        <div class="m-3">
                            <textarea name="message"  class="form-control mx-1" style="resize: none; border-radius: 1rem;" placeholder="Your feedback...." name="text-result" id="" cols="50" rows="10" ></textarea>
                        </div>
                        <div class=" w-100 d-flex justify-content-center">
                            <button class="btn btn-primary mx-5" type="button">BACK</button>
                            <button class="btn btn-primary mx-5" type="submit">SEND</button>
                        </div>
                    </form>
                </div>
