...
%>
        <form action="login" method="post">
            ...
            <div class="form-group" style="margin-top:30px;">              
                <input style=" font-size: x-small;" type="text" id="username" name="username" placeholder="Username" required value = "<%=uname %>" />
            </div>
            <div class="form-group" style="margin-top:30px;">      
           ...
           <input type="checkbox" id="rememberMe" name="rememberMe" value= "1" <%= "1".equals(reme) ?  "checked='/checked'" : "" %> />
                ...
                <div class="form-group row">
                    ...
                    <button class="col-12 col-md-6 " style="margin-left:20px"><a href="SignUp.jsp" style="color:black;"> Sign Up </a></button>
                </div>       
        </form>
    </div>
</body>
