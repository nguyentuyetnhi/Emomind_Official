    ...
    <div class="login-container" style="height:600px;">
        ...
        <form action="signup" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-top:30px;">              
                <input style=" font-size: x-small;" type="text" id="username" name="username" placeholder="Username" required />
            </div>
            <div class="form-group" style="margin-top:30px;">          
                <input  style=" font-size: x-small;"type="password" id="password" name="password" placeholder="Password" required />
            </div>
            <div class="form-group" style="margin-top:30px;">              
                <input style=" font-size: x-small;" type="text" id="name" name="name" placeholder="Name" required />
            </div>
            <div class="form-group" style="margin-top:30px;">
            
                <input  style=" font-size: x-small;"type="text" id="email" name="email" placeholder="Email address" required />
            </div>
            <div class="form-group" style="margin-top:30px;">
            
                <input  style=" font-size: x-small;"type="text" id="phone" name="phone" placeholder="Phone" required/>
            </div>         
                <div class="form-group row">
                    <button class="col-12 col-md-6 " type="submit"><a href = "login.jsp" style="color:black;"> Sign In </a></button>
                        
                    <button class="col-12 col-md-6 " style="margin-left:20px;"><a style="color:black;"> Sign Up </a></button>
                </div>       
        </form>
    </div>
</body>
