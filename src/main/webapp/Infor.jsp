        ...
        <div class="container">
            <div class="row feedback">
                <div class="col-md-5 feedback-user">
                    ...
                    <i> User ID: ${account.id}</i>
                    <h2 class="feedback-nameuser" style = "color: red">${account.username}</h2>
                    <img src="img/${account.img}" alt ="No picture added yet!" height="200" width="200">
                </div>
                <div class="col-md-7 info-content">
                    <div class="info-content-items">
                        <h6 class="info-content-item">Name: </h6>
                        <h6 class="info-content-item" style = "color: red">${account.name}</h6>
                    </div>
                    <div class="info-content-items">
                        <h6 class="info-content-item">Email:</h6>
                        <h6 class="info-content-item" style = "color: red">${account.email}</h6>
                    </div>
                    <div class="info-content-items">
                        <h6 class="info-content-item">Phone:</h6>
                        <h6 class="info-content-item" style = "color: red">${account.phone}</h6>
                    </div>                  
                </div> 
                
            </div>
            <div class="w-100 d-flex justify-content-end">
                <button class="btn btn-primary mx-2"> <a href="update?username=${account.username}" style="color:black;"> CHANGE PASSWORD </a> </button>
                <button class="btn btn-primary mx-2"> <a href="edit?username=${account.username}" style="color:black;">EDIT </a> </button>
                <button class="btn btn-primary mx-2"> <a href="share.jsp" style="color:black;"> BACK </a> </button>
            </div>
