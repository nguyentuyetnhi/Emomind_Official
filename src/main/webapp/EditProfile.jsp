        ...
        <div class="container">
            <div class="row feedback">         
                <div class="col-md-5 feedback-user">
                    ...
                    <i style = "color: blue">ID:${account.id}</i>
                ...
                <div class="col-md-7 info-content">
                    <div class="form-group" style="margin-top:30px;">              
                        <input style=" font-size: x-small; height: 50px; width: 400px" type="text" id="username" name="username" readonly value = "${account.username}" />
                    </div>
                    <div class="form-group" style="margin-top:30px;">              
                        <input style=" font-size: x-small; height: 50px; width: 400px" type="text" id="name" name="name" required value = "${account.name}" />
                    </div>
                    <div class="form-group" style="margin-top:30px;">              
                        <input style=" font-size: x-small; height: 50px; width: 400px" type="text" id="email" name="email" required value = "${account.email}" />
                    </div>
                    <div class="form-group" style="margin-top:30px;">              
                        <input style=" font-size: x-small; height: 50px; width: 400px" type="text" id="phone" name="phone" required value = "${account.phone}" />
                    </div>
                </div> 
