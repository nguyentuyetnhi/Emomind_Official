        ...
        <form action="update" method="post" enctype="multipart/form-data">         
            <div class="login-container" style="height:400px;">      
                ...
                <div class="form-group" style="margin-top:-20px;">
                    <input type="text" id="username" name="username" readonly value = "${account.username}">    
                    <br>
                    <br>
                ...
                <div class="form-group row">
                    <button class="col-12 col-md-6 " style="margin-left:60px;" type="submit"><a style="color:black;"> Send </a></button>
                        
                    <button class="col-12 col-md-6 " style="margin-left:20px;" type="submit"><a href="share.jsp" style="color:black;"> Back </a></button>
                </div>       
            </div>
        </form>
